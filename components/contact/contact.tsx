...
const ContactInfoCard = ({
    ...
    const CardContent = (
        <div className={cn("p-6 rounded-2xl flex items-center gap-6 transition-all duration-300 group hover:bg-primary/5", GLASS_EFFECTS)}>
            ...
            <div>
                ...
                <p className="text-lg font-bold text-foreground group-hover:text-primary transition-colors">{content}</p>
            </div>
        </div>
    );
            ...
            <div className="max-w-7xl w-full mx-auto space-y-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="pt-8">
                            <p className="text-sm font-semibold text-foreground/50 uppercase tracking-widest mb-4">Social Profiles</p>
                            <div className="flex gap-4">
                                {socialLinks.map((social) => (
                                    ...
                                    >
                                        <span className="w-6 h-6 block [&>svg]:w-full [&>svg]:h-full">{social.icon}</span>
                                    </Link>
                                ))}
                            </div>
                        </div>
