...
const ExperienceItem = ({ exp, index }: { exp: (typeof experiences)[0]; index: number }) => {
    return (
        <div className="relative pl-8 md:pl-0">
            {/* Timeline Dot */}
            <div className="absolute left-0 md:left-1/2 top-0 -translate-x-1/2 flex items-center justify-center w-12 h-12 rounded-full bg-background border-4 border-primary z-10 shadow-[0_0_15px_rgba(var(--primary),0.5)]">
                <div className="text-primary">{exp.icon}</div>
            </div>

            <div className={cn(
                "flex flex-col mb-12",
                index % 2 === 0 ? "md:items-end md:mr-[50%] md:pr-12" : "md:items-start md:ml-[50%] md:pl-12"
            )}>
                <motion.div
                    ...
                    className={cn(
                        "p-6 mt-0 w-full max-w-lg rounded-3xl relative group",
                        GLASS_EFFECTS
                    )}
                >
        ...
        <section id="experience" className="min-h-screen py-24 px-4 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                <div className="relative">
                    ...
                    <div className="absolute left-[24px] md:left-1/2 top-4 bottom-4 w-px bg-linear-to-b from-transparent via-primary/30 to-transparent -translate-x-1/2 hidden sm:block" />
