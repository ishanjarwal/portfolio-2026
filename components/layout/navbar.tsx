...
export function Navbar() {
    return (
        <div className="fixed top-4 left-0 right-0 z-50 flex justify-center p-2">
            <nav className="flex items-center justify-between gap-4 rounded-full border border-border/40 bg-background/80 p-2 ps-6 shadow-lg backdrop-blur-md transition-all hover:border-border/80 w-fit">
