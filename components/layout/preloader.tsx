        ...
        >
          <div className="relative flex flex-col items-center gap-8">
            ...
            <div className="relative">
              <h2 className="text-4xl md:text-7xl font-black text-white/5 tracking-tighter uppercase select-none">
                Ishan Jarwal
              </h2>
              <motion.h2
                style={{ clipPath: `inset(${100 - progress}% 0 0 0)` }}
                className="absolute inset-0 text-4xl md:text-7xl font-black text-primary tracking-tighter uppercase select-none"
              >
                Ishan Jarwal
              </motion.h2>
            </div>
